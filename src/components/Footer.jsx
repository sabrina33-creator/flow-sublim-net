...
import { C, F, SITE_NAME, PHONE, PHONE_DISPLAY, EMAIL, WHATSAPP, ADDRESS } from '../tokens';
    ...
    <footer style={{ background: C.dark, color: 'rgba(255,255,255,0.7)', paddingTop: 64, paddingBottom: 40 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
        ...
        <div style={{
          ...
          {/* Colonne 1 — marque */}
          <div>
            <div style={{ fontFamily: F.heading, fontSize: 22, fontWeight: 700, color: C.white, marginBottom: 12 }}>
              {SITE_NAME}
            </div>
            {/* [TODO: Ajouter le logo SVG ici ou une courte accroche] */}
            <p style={{ fontSize: 14, lineHeight: 1.7, maxWidth: 240 }}>
              [TODO: Courte description du service en 2 lignes max.]
            </p>
          </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, fontSize: 14, color: 'rgba(255,255,255,0.65)' }}>
                <PinIcon size={14} style={{ marginTop: 3, flexShrink: 0 }} /> {ADDRESS}
              </div>
            </div>
          </div>
        </div>

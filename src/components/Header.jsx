      ...
      <header style={{
        ...
        <div style={{
          ...
          <Link
            ...
            style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 10, minHeight: 44 }}
          >
            {/* [TODO: Remplacer ce bloc par le logo SVG du client] */}
            <div style={{
              width: 36, height: 36, borderRadius: 8,
              background: C.primary,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              color: '#fff', fontFamily: F.heading, fontWeight: 700, fontSize: 18,
              flexShrink: 0,
            }}>
              {SITE_NAME.charAt(0)}
            </div>
            <span style={{
              ...
              color: fg, transition: 'color 0.35s',
            }}>
              {SITE_NAME}
            </span>
          </Link>
